...
**<span style="color: red">本页介绍的是「城镇生存服」的常用指令。</span>**
...
**<span style="color: red">本页介绍的是「自由创造服」的常用指令。</span>**

?> 输入`/c`打开 *快捷菜单*。

#### 跨服聊天 :id=creative

<!-- 在每个服务器的跨服聊天加上对应的id，以实现直接跳转到选项卡 -->
...
**<span style="color: red">本页介绍的是「探索模组服」的常用指令。</span>**
...
- 传送
  - `/back` 回到最近一次的传送点
    - 注1 *back 指令不能回到死亡地点，但你可以按住右键使用 **带有附魔的坟墓钥匙** 回去*
