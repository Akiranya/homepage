...
我们目前提供支付宝个人收款码来接收捐助款项。

**支付宝收款账号：**`mizuki@craf.tw`

![](https://mimaru-jp.oss-ap-northeast-1.aliyuncs.com/images/donation-qrcode.JPG ':size=350')
...
> 若`您购买的米团时长`或`您捐助的人民币数额`没有直接出现在以上表格中（但大于最小套餐），那么我们将以最优惠的方式用`现有的时长/价格`进行组合，然后算出最优惠价格之和。此价格之和将会成为你获得权益所需要支付的最终人民币数额。小于最小套餐的金额或时长将视为无偿捐助。
