...
**技术流程服务于活动流程。**你所看到的比赛技术流程都是根据活动流程来设计的。

如果活动流程有需要强制措施才能实现的规则（比如玩家只能在规定时间之后开始建造），请联系小米说明活动流程的需求。小米会考虑什么样的技术流程才可以保证活动流程按所期望的进行，然后写在这里。
...
- 使用`/p2 wea`指令让自己在任意地皮里使用WE
- 拥有在任意地皮里的所有权限（建造/破坏/交互等）
