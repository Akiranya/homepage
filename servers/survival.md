...
在特定区域钓鱼，你可以钓到服务器特有的物品（包括武器、盔甲、稀有材料等等），不过这也意味着你需要掌握一套新的钓鱼技巧。
在钓到宝物时，你会看到类似“有东西上钩了”的提示。这时你需要做的是反复右键（拉钩）一定次数来收线，否则将一无所获。
在特定区域钓鱼也可以增加你的钓鱼等级，具体请见生产技艺。

👉[渔场列表一览](/features/mmocore/fishing.md)

## 生产技艺 :id=professions

生产技艺代表生产活动的熟练度，包括挖矿、砍树、熔炼等等。完成生产活动的次数越多，你的相应生产技艺等级也就越高。
注意生产技艺本身不提供任何加成（钓鱼除外），但越高的生产技艺的等级能够在合成站解锁更多配方。
...
**人物主等级**（简称“主等级”）代表了你人物的整体强度，你可以通过击杀特定怪物和完成冒险世界的任务来升级。
**人物属性**（简称“属性”）是4种人物属性的统称：力量、耐力、敏捷、智力。每种人物属性以点数的多少来区分高低，可以为你提供永久的加成效果。
每当你的主等级提升1级，将获得3点可自由分配的属性点。根据喜好，你可以分配这些点数到特定的人物属性上。例如你喜欢玩法师，那么就把属性点加到智力上来提高法强和魔法回复。
...
服务器添加了大量原创**独特物品**，包括武器、盔甲、材料等等，同时也增加了好几种全新的物品机制。获得这些独特物品的途径之一就是使用**合成站**，除此之外也可以通过完成任务、攻略副本等途径获得。
作为入坑的第一步，你应该先去看看主城的*冒险工作室*，那里聚集了一些具有合成站功能的NPC，他们会告诉你该如何操作。
