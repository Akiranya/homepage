...
> 陶可尼亚是一个以冒险与探索、收集与建造为主题的生存服务器。建设并经营自己的[城镇](/plugins/towny.md)是这里的主线，与此同时还有以黄金为本位币、玩家自己主导的[自由市场经济系统](#eco)。陶可尼亚还有可玩性极高的插件，例如仿模组的[粘液科技](/plugins/slimefun.md)，养成类的[宠物系统](/plugins/mypet.md)，实用类的[机械工艺](/plugins/craftbook.md)等等。
