...
> 陶可尼亚是一个以冒险与探索、收集与建造为主题的生存服务器。建设并经营自己的[城镇](/plugins/towny.md)是这里的主线，与此同时还有以黄金为本位币的[经济系统](#eco)。陶可尼亚还有可玩性极高的插件，例如类似模组的[粘液科技](/plugins/slimefun.md)，养成类的[宠物系统](/plugins/mypet.md)，实用类的[机械工艺](/plugins/craftbook.md)等等。
...
- 创建`城镇`，扩张领地，经营属于你的小镇，最终结盟建国
- 抓只`宠物`，将其升级成你的移动背包、移动信标，甚至骑着它飞行
- `粘液科技`，新增500多种科技与魔法类的物品/方块和200多种研究
- 以黄金为本位币的`实体货币`经济系统
- 全服交易平台`拍卖行`，支持方便快捷的线上远程交易
- 创建自定义村民，在中央集市开设你的`村民商店`，与其他玩家交易
- 支持建造`木牌电梯`，让你在垂直空间内进行快速传送
- 支持`定向随机传送`，快速到达理想的生物群系
- 工匠及更高级的玩家可在城镇领地内使用`飞行模式`
- 可以自定义聊天的`后缀`和`昵称`，且支持中文和颜色代码
- `高级成就`系统，解锁阶段性成就，获得丰厚奖励
- `记录查询`系统，看看是谁动了你的东西/动物
...
![auctionhouse](https://proxy.spigotmc.org/26f5ba689eadfa1ec290c5b92c750af64f00e585?url=https%3A%2F%2Fwww.spawnchunk.com%2Fauctionhouse%2Fimages%2Fauctionhouse2.png)
