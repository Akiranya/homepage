...
> **陶可尼亚**完全继承原版生存的游戏玩法。在此基础上，这里添加了很多趣味十足的插件～建设并经营自己的[城镇](/plugins/towny.md)是这里的主线。除此之外还有玩家自己主导、以黄金为本位币的[自由市场经济](#eco)。这里新增了500多种科技/魔法物品的[粘液科技](/plugins/slimefun.md)，养成类的[宠物系统](/plugins/mypet.md)，实用类的[机械工艺](/plugins/craftbook.md)，以及额外的、带有阶段性奖励的成就系统。
