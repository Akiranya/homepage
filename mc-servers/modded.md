...
*软妹币* 是模组服的通用虚拟货币，玩家可以把金锭拿在手上然后输入`/sell`来换成软妹币。软妹币可以用来和其他玩家交易（例如购买 *天喵商城* 的商品；输入`/gts`即可浏览天喵商城）。如果你想出售物品到天喵商城，输入`/gts sell`。关于完整的指令，参考[常用指令·模组探索服](/welcome/commands-modded.md)。
