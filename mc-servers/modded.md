...
*注：由于模组服和生存服的经济系统不太一样，所以为了区分，模组服的虚拟货币叫做「次元币」。*

模组服有虚拟货币系统，货币单位 *次元币*。玩家可以把 *金锭* 拿在手上然后输入`/sell`把金锭换成 *次元币*，兑换比例`1金锭⇒9次元币`。反过来你也可以从系统购买金锭，指令`/buy [要购买的金锭数量]`，兑换比例`18次元币⇒1金锭`。
...
关于次元币 & 天喵商城的所有指令，请查看👉[常用指令·模组探索服](/welcome/commands-modded.md)
