...
- 优化过的游戏设定 - 为创作量身打造的游戏设定，例如生物不会破坏方块，冰块不会融化
- 可使用作弊指令 - 自由调节世界时间、天气，也可定点坐标传送
- 老地图展览 - 存放了上古服诞生至今的大部分老地图存档，玩家可前往参观和怀旧
- 快捷菜单 - 大部分指令/功能已集成到快捷菜单，不用再打指令啦
- 创世神 - 有机会使用创世神插件（地图编辑器）
...
- 建筑比赛·第六届<sub>图书馆（下角标为建筑比赛的主题）</sub>
- 建筑比赛·第七届<sub>自拟</sub>
...
玩家可以通过快捷菜单<sub>（指令`/c`）</sub>里的`世界传送`面板前往这些旧世界参观。
