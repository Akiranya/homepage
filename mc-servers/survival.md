...
> **城镇生存服**完全继承了原版生存的游戏体验。在此基础上，这里添加了很多趣味十足的插件～建设并经营自己的[城镇](/plugins/towny.md)是贯穿这里的主线。除此之外主城还拥有以**原木**换万物的`系统兑换商店`，是建材源源不断的无限来源。并且**[家园世界](#home_worlds)长期不换图**，适合喜欢玩长期地图的玩家（建筑党的福音）。完整的插件列表详见[插件列表](#plugins)。
